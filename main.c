...
printf("Hello Vulkan!");
//clang main.c -o main -lglfw -lvulkan
//glslangValidator -V -o vert.spv shader.vert
//glslangValidator -V -o frag.spv shader.frag
...
glfwInit();
	...
	strcpy(app_name,"Vulkan-Renderer");
	...
	GLFWwindow *window=
		glfwCreateWindow(1200,1000,"Vulkan-Renderer",NULL,NULL);
	...
	rendp_area.extent=
		swap_cre_info.imageExtent;
	VkClearValue clear_val={0.678f,0.847,0.902f,0.0f};
	for(uint32_t i=0;i<swap_image_count;i++){
